 ...
 * @author Asus
 */
public class nhapMaTVForm extends javax.swing.JFrame {

    ThanhVienBLL thanhVienBLL;
    ThongTinSuDungBLL ttsdBLL;
    
    public nhapMaTVForm() {
        initComponents();
        thanhVienBLL = new ThanhVienBLL();
        ttsdBLL = new ThongTinSuDungBLL();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nhapMaTVForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nhapMaTVForm().setVisible(true);
            }
        });
    }
